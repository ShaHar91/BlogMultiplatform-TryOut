...
sealed class ApiListResponse {
    ...
    @Serializable
    @SerialName("success")
    data class Success(val data: List<SimplePost>): ApiListResponse()
    @Serializable
    @SerialName("error")
...
object ApiListResponseSerializer: JsonContentPolymorphicSerializer<ApiListResponse>(ApiListResponse::class){
    override fun selectDeserializer(element: JsonElement): DeserializationStrategy<out ApiListResponse> = when {
...
object ApiResponseSerializer: JsonContentPolymorphicSerializer<ApiResponse>(ApiResponse::class){
    override fun selectDeserializer(element: JsonElement): DeserializationStrategy<out ApiResponse> = when {
